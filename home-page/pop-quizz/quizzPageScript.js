...
const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "2 Chainz", correct: false},
        ],
        hint: "Hint: sang Gods plan",
        skipped: false,
    },
    {
        question: "What was the cause of Marilyn Monroes suicide?",
        answers: [
            { text: "Knife Attack", correct: false},
            { text: "Drug Overdose", correct: true},
            { text: "House Fire", correct: false},
            { text: "Gunshot", correct: false},
        ],
        hint: "Hint: it starts with d",
        skipped: false,
    },
    {
